              ...
              <form className="space-y-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-80 mx-1 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring focus:ring-black/40 box-border"
                  />
                </div>
            ...
            >
              <form className="space-y-4">
                <div>
                  <label
                    htmlFor="name"
                    className="block mx-1 text-sm font-medium text-gray-700"
                  >
                    Name
                  </label>
                  <input
                    ...
                    placeholder="name"
                    required
                    className="w-80 mx-1 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring focus:ring-black/40"
                  />
                </div>
                <div>
                  <label
                ...
                <div>
                <label htmlFor="password" className="block mx-1 text-sm font-medium text-gray-700">
                  Password
                </label>
                <input
                  type="password"
