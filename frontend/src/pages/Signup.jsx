...
//   // Validation with Dynamic Error Messaging
//   const validateForm = () => {
...
//         {/* Signup Form with Left-to-Right Animations */}
//         <div className="w-full md:w-1/2 p-6 md:p-10 flex flex-col justify-center bg-gray-50 rounded-r-lg shadow-inner">
//           <h2 className="text-2xl md:text-3xl font-bold text-center text-gray-800 mb-4 animate-slideInRight">
//             Create an Account
//           </h2>
